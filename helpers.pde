...
/*void mouse_point() {
  ...
  switch(screen_rotate) {
    case 0: 
      ...
      xpixel = parseInt(mouseX/screen_scale - mx);
      ypixel = parseInt(mouseY/screen_scale - my);
      break;
    case 1: 
      println(  (mouseY/screen_scale - my) + ", " + -(mouseX/screen_scale - mx) );
      xpixel = parseInt(mouseX/screen_scale - my);
      ypixel = parseInt(mouseY/screen_scale - mx);
      break;
    case 2: 
      println( -(mouseX/screen_scale - mx) + ", " + -(mouseY/screen_scale - my) );
      xpixel = parseInt(mouseX/screen_scale - mx);
    ...
    case 3: 
      ...
      break;
        ...
        print("Red: "+red(img_orginal.pixels[xpixel + ypixel * canvas_size_x]));
        print(" Green: "+green(img_orginal.pixels[xpixel + ypixel * canvas_size_x]));
