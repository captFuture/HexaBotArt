...
///////////////////////////////////////////////////////////////////////////////////////////////////////
void create_gcode_filesxxx (int line_count) {
  boolean is_pen_down;
  int pen_lifts;
  float pen_movement;
  float pen_drawing;
    ...
    for(int i=1; i<line_count; i++) { 
      if (d1.lines[i].pen_number == p) {
        ...
        if (x != gcode_scaled_x1 || y != gcode_scaled_y1) {
          ...
          String buf = "G0 X" + int(gcode_scaled_x1) + " Y" + int(gcode_scaled_y1);
          OUTPUT.println(buf);
          x = gcode_scaled_x1;
          y = gcode_scaled_y1;
        ...
        String buf = "G1 X" + int(gcode_scaled_x2) + " Y" + int(gcode_scaled_y2);
        OUTPUT.println(buf);
        //x = gcode_scaled_x2;
        //y = gcode_scaled_y2;
